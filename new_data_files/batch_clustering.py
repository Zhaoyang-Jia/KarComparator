...
omkar_folder = 'OMKar_testbuild3/'
omkar_output_folder = '../batch_processing/OMKar_testbuild3/'  # to access the dummy edge and change in CNV
forbidden_region_file = '../Metadata/acrocentric_telo_cen.bed'
output_dir = 'cluster_files_testbuild6/'
